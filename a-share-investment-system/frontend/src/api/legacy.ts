...
export const marketApi = { getRegime: () => get('/api/market/regime') }
export const riskApi = { getStatus: () => get('/api/risk/status') }
export const signalsApi = { getToday: () => get('/api/signals/today') }
export const systemApi = { getStatus: () => get('/api/system/status') }
...
export const screeningApi = {
  run: () => get('/api/screening/run'),
  getStatus: () => get('/api/screening/status'),
  getResults: () => get('/api/screening/results'),
}
export const dbApi = {
...
export const logsApi = {
  getRecent: (params?: any) => get('/api/logs/recent', params),
  getErrors: () => get('/api/logs/errors'),
  clear: () => del('/api/logs/clear'),
}
